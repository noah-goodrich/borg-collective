...
test-viz:
	@if [ -d merge-tree ]; then \
		...
		coverage report -m --include='merge-tree/curate.py,merge-tree/render_graph.py,merge-tree/spine.py,merge-tree/gather.py,merge-tree/programs.py,merge-tree/backfill.py,merge-tree/coordinator.py' --fail-under=85; \
	else \
