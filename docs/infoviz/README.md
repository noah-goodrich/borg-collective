...
Carried open items, independent of track order: run both comprehension checks against a real human (never
done — every empirical-test verdict is a reasoned prediction); Few beyond Ch. 1 needs a legitimate copy; the
useful-chrome-vs-cute-gauge boundary test exists in neither phase (parked, downgraded 2026-08-10).
