...
CLAUDE.md is explicit: recon sources are NEVER hardcoded; Ontra adapters (Slack/Jira/Notion) are a machine-injected
...
adapters shadowing it. So this rewrite is observable end-to-end here, and the Ontra layer on the work machine is
