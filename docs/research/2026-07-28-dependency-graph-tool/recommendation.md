...
- Two commands on either machine: `hub build && hub serve`, dark theme, all JS vendored, Ontra data never
  leaving the box.
...
both machines: generic code lives in borg-collective (public repo), Ontra data stays machine-local and never
