...
class TestSlugify:
    def test_prose_project_name_becomes_a_stable_slug(self):
        assert slugify("SFP - Keypair migration") == "sfp-keypair-migration"
    ...
    def test_is_idempotent_so_reslugging_a_slug_is_a_no_op(self):
        ...
        once = slugify("SFP - SME-PAT provisioning")
...
class TestDerivedFields:
    ...
    def test_cross_repo_blocking_edge_is_derived_from_the_real_fixture(self):
        # The capability this whole directive exists for: snowflake-permissions#301 is blocked by
        ...
        found = [
            ...
            if "snowflake-permissions#301" in ws["items"]
        ]
...
class TestSkeletonFromRealFixture:
    ...
    def test_the_pat_trio_groups_as_one_workstream(self):
        ...
        trio = {
            "snowflake-permissions#339",
            "snowflake-permissions#340",
            "snowflake-permissions#341",
        }
    ...
    def test_gather_name_is_retained_as_provenance(self):
        ...
        assert by_id["sfp-keypair-migration"]["gather_name"] == "SFP - Keypair migration"
...
class TestOverlayRoundTrip:
    ...
    def test_judgment_is_applied_onto_the_skeleton(self):
        ...
        ws = next(w for w in pr["workstreams"] if w["key"] == "snowflake-permissions#292")
    ...
    def test_name_falls_back_to_the_gather_name_when_unjudged(self):
        ...
        assert by_id["sfp-snowpipe"]["name"] == "SFP - Snowpipe"
