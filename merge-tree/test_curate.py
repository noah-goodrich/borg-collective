...
class TestCurate:
    ...
    def test_golden_fixture_produces_expected_bucket_counts(self):
        ...
        # awaiting-you derivation landed. Three of them are warehouse-permissions#339/#340/#341 --
        # the team-token trio that was buried inside its chain and never surfaced on 2026-08-10. That
