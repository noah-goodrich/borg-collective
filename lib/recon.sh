...
#   6. Persist: thin, optional, fail-quiet cairn hook. Never a hard dependency.
#
...
# Colon-separated search path for adapters. User-injected adapters (e.g. an Ontra layer on a work
